...
sudo iptables -t nat -A POSTROUTING -p tcp --match multiport --dports  8080,1443 -j MASQUERADE 
sudo iptables -t nat -A PREROUTING -p tcp --match multiport --dports  1443,1443 -j DNAT --to-destination $IP
